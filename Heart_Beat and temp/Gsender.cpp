...
bool Gsender::Send(const String &to, const String &message , int number )
{
  ...
  client.println();
  String body = "<!DOCTYPE html><html lang=\"en\">" + message +"<b> "+ number + "</b> <br>    Thanks For Using our Service! </html>";
  client.println(body);
  client.println(".");
  if (!AwaitSMTPResponse(client, "250")) {
